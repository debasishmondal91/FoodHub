...
package com.example.foodhub.android.theme
...
private val LightColorPalette = FoodHubColors(
    brand = Shadow5,
...
private val DarkColorPalette = FoodHubColors(
    brand = Shadow1,
...
class FoodHubColors(
    ...
    fun update(other: FoodHubColors) {
    ...
    fun copy(): FoodHubColors = FoodHubColors(
...
private val LocalJetsnackColors = staticCompositionLocalOf<FoodHubColors> {
